...
import { DayViewProps } from "@/props/DayViewProps";
    ...
    return (
        <View style={styles.dayColumn}>
            <View style={styles.dayHeader}>
                <Text style={styles.dayWeek}>{date.toLocaleDateString('en-US', { weekday: 'short' })}</Text>
            ...
            <View style={styles.dayBody}>
                {tasks.map(task => (
                    ...
                    >
                        ...
                        >
                            {task.completed ? <CheckCircle size={16} color="#22C55E" /> : <Circle size={16} color="#9CA3AF" />}
                        </Pressable>

                        <View style={styles.taskInfo}>
                            <Text numberOfLines={1} style={[styles.taskName, task.completed && styles.taskNameDone]}>
                                {task.name}
                            </Text>
